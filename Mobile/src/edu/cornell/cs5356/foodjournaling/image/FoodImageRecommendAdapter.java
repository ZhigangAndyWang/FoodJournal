...
public class FoodImageRecommendAdapter extends ArrayAdapter<FoodImage> {
	public FoodImageRecommendAdapter(Context context, ArrayList<FoodImage> foodImages) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(getContext()).inflate(
					R.layout.item_food_image_recommend, parent, false);
		}
		...
		tvUsername.setText(foodImage.getUsername());
